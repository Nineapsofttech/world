...
<html>
<head>
<title><? if($blog_rows[blog_header]=="")echo "blog ของ $blog_rows[login]";else echo $blog_rows[blog_header]?></title>
<link rel="image_src" href="http://www.niyay.com<?=$logo_pic;?>" />
<meta name="description" content="แวะมาเยี่ยม blog ของ <?=$blog_rows[login];?> กันเยอะ ๆ นะจ๊ะ" />
...
function Send_Form(pForm,display,sync_method){
	...
	xhr.onreadystatechange = function() {//Call a function when the state changes.
		if(xhr.readyState == 4 && xhr.status == 200) {
			...
			document.getElementById(display).innerHTML = '<img src=\'/img/pleasewait.gif\'><br>ถ้ารอนานเกินไปก็กด submit ได้เลยจ้า'; 
	}
	xhr.send(pBody);
}
...
function send_ment(){
	...
	//if(pForm.ment.value==""){
		...
		xmlhttpPost('/blog/blog_ment_save2.php', 'frm_ment', 'ment_display', '<img src=\'/img/pleasewait.gif\'><br>ถ้ารอนานเกินไปก็กด submit ได้เลยจ้า'); 
		show_ment();
	}
...
function send_cool(){
	...
	alert("ส่ง cool เย็น ๆ ถึงเพื่อนคุณแล้วค่ะ");
...
function show_main_horo() {
	...
	xhr.onreadystatechange = function () { 
		  if (xhr.readyState==4 && xhr.status==200) {
				document.getElementById("show_main_horo").innerHTML=xhr.responseText; //รับค่ากลับมา
		  }
	};
	
	xhr.open("GET", "/blog/show_main_horo.php"+param,true); //สร้าง connection
	xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=utf-8"); // set Header
	xhr.send(null); //ส่งค่า
}
...
function show_horo(s_date) {
	...
	xhr.onreadystatechange = function () { 
		  if (xhr.readyState==4 && xhr.status==200) {
				document.getElementById("show_horo").innerHTML=xhr.responseText; //รับค่ากลับมา
		  }
	};
	
	xhr.open("GET", "/blog/show_horo.php"+param,true); //สร้าง connection
	xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=utf-8"); // set Header
	xhr.send(null); //ส่งค่า
}
...
function show_dream(dream) {
	...
	xhr.onreadystatechange = function () { 
		  if (xhr.readyState==4 && xhr.status==200) {
				document.getElementById("show_dream").innerHTML=xhr.responseText; //รับค่ากลับมา
		  }
	};
	
	xhr.open("GET", "/blog/show_dream.php"+param,true); //สร้าง connection
	xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=utf-8"); // set Header
	xhr.send(null); //ส่งค่า
}
...
function show_cool(file_name) {
	...
	xhr.onreadystatechange = function () { 
		  if (xhr.readyState==4 && xhr.status==200) {
				document.getElementById("show_cool_story").innerHTML=xhr.responseText; //รับค่ากลับมา
		  }
	};
	
	xhr.open("GET", file_name+param,true); //สร้าง connection
	xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=utf-8"); // set Header
	xhr.send(null); //ส่งค่า
}
...
function show_cool_blog(file_name) {
	...
	xhr.onreadystatechange = function () { 
		  if (xhr.readyState==4 && xhr.status==200) {
				document.getElementById("show_cool_blog").innerHTML=xhr.responseText; //รับค่ากลับมา
		  }
	};
...
function show_favorites(file_name) {
	...
	xhr.onreadystatechange = function () { 
		  if (xhr.readyState==4 && xhr.status==200) {
				document.getElementById("show_favorites").innerHTML=xhr.responseText; //รับค่ากลับมา
		  }
	};
...
function add_friend() {
	...
	xhr.onreadystatechange = function () { 
		  if (xhr.readyState==4 && xhr.status==200) {
				document.getElementById("add_friend_display").innerHTML=xhr.responseText; //รับค่ากลับมา
		  }
		  else{
	...
	xhr.open("GET", "/blog/friend_add.php?blog_id=<? echo $_GET[blog_id]?>",true); //สร้าง connection
	xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=utf-8"); // set Header
	xhr.send(null); //ส่งค่า
}
...
function block_friend() {
	...
	xhr.onreadystatechange = function () { 
		  if (xhr.readyState==4 && xhr.status==200) {
				document.getElementById("block_friend_display").innerHTML=xhr.responseText; //รับค่ากลับมา
		  }
		  else{
	...
	xhr.open("GET", "/blog/friend_ban.php?user_id=<? echo $_GET[blog_id]?>&from_blog=1",true); //สร้าง connection
	xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=utf-8"); // set Header
	xhr.send(null); //ส่งค่า
}
...
function show_user_online_now() {
	...
	xhr.onreadystatechange = function () { 
		if (xhr.readyState==4 && xhr.status==200) 
			document.getElementById("show_online_now").innerHTML=xhr.responseText; //รับค่ากลับมา
		else
		  	document.getElementById("show_online_now").innerHTML = '<div align=center><img src=\'/img/pleasewait.gif\'></div>';
	};
	//alert ("555");
	xhr.open("GET", "/blog/friend_online.php?blog_id=<?=$blog_id;?>&t=" + xdate.getTime(),false); //สร้าง connection
	xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=utf-8"); // set Header
	xhr.send(null); //ส่งค่า
}
...
function show_visitor(by_click) {
	...
	xhr.onreadystatechange = function () { 
		if (xhr.readyState==4 && xhr.status==200) 
			document.getElementById("show_visitor").innerHTML=xhr.responseText; //รับค่ากลับมา
		else //if(by_click==1)
		  	document.getElementById("show_visitor").innerHTML = '<div align=center><img src=\'/img/pleasewait.gif\'></div>';
	};
	//alert(by_click);
	//xhr.open("GET", "/blog/history/blog_visitor_<?=$blog_id;?>.html?t=" + xdate.getTime(),true); //สร้าง connection
	xhr.open("GET", "/blog/blog_visitor2.php?blog_id=<?=$blog_id;?>&t=" + xdate.getTime(),true); //สร้าง connection
...
//alert(show_x+" : " + interval);
	xhr.onreadystatechange = function() {//Call a function when the state changes.
		if(xhr.readyState == 4 && xhr.status == 200) {
			...
			if(reply_id!="")
				document.getElementById("ment_display").innerHTML = "<br><img src=\'/img/pleasewait.gif\'><p><a href='javascript:show_ment_page("+reply_id+",1)'><font color='<? echo $ment_fg?>'>ถ้ารอนานแล้ว comment ไม่ขึ้น ก็ให้คลิก ที่นี่ ได้เลยจ้า..</font></a> <img src='/img/icon_update.gif' width='45' height='14' /></p>";
		}
	}
	xhr.send(null);
}
...
function show_ment(reply_id){
	...
	xhr.onreadystatechange = function() {//Call a function when the state changes.
		...
		if(xhr.readyState == 4 && xhr.status == 200) {
			...
			if(reply_id!=0){
				str_y="<img src='/img/pleasewait.gif'><br><font color='<? echo $ment_fg?>'>ถ้ารอนานเกินไปก็ คลิก submit ได้เลยจ้า</font>";
