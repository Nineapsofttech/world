<!DOCTYPE html>
<html lang="en"><!-- InstanceBegin template="/Templates/template_info.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
<meta charset="utf-8">
...
<!--Content-->
<div class="maincontent"><!-- InstanceBeginEditable name="EditRegion1" --><!--Left Content for Information-->
...
<div class="margininfomation"><!-- TemplateBeginEditable name="EditRegion2" -->EditRegion2<!-- TemplateEndEditable --></div>
</div>
<!--Right Content for Information-->
